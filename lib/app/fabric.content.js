 ...
 * 
 */
 export const FormassociatedContent = new FlatContract(function (subject) {
    return instanceOf(subject, HTMLElement) && categoryOf(subject.categories, FORMASSOCIATED);
}, `Expect subject to be 'Form-associated Content'!`);